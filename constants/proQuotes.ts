...
export const DAILY_QUOTES: DailyQuote[] = [
  ...
  // BOARD-COUNT FIX 2026-08-11 — these five quotes asserted "four boards" as a rule. The count
  // is dynamic (2P=4, 3P=3, 4P=2), so it is true only at 2 players. Each rewrite drops the
  // NUMBER and keeps the voice, length and claim; no new statement about the game is invented.
