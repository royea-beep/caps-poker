/**
 * Card-visual BEFORE captures — /game at 3 widths to see suit layout + zone split.
 * Uploads to Supabase `screenshots/caps-2026-05-22-card-visual-before/`.
 */
...
const FOLDER = 'caps-2026-05-22-card-visual-before';
  ...
  for (const w of WIDTHS) {
    ...
    for (const r of ROUTES) {
      ...
      try {
        ...
        console.log(`[card] ${tag.padEnd(14)} ${url ? '✅' : '❌'}`);
      } catch(e) { console.log(`[card] ${tag} ❌ ${e.message}`); }
