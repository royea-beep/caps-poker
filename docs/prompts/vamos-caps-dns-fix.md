...
3. Use cPanel API to check the DNS zone:
   curl -s -u "ftableco:CPANEL_PASSWORD_REDACTED" "https://ftable.co.il:2083/json-api/cpanel?cpanel_jsonapi_user=ftableco&cpanel_jsonapi_apiversion=2&cpanel_jsonapi_module=ZoneEdit&cpanel_jsonapi_func=fetchzone&domain=ftable.co.il" 2>&1 | grep -i caps
