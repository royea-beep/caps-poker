...
- **Contact Email**: royearguan@gmail.com
- **Demo Account**: Not needed (single-player, no login)
- **Notes for Reviewer**:
...
Place your cards across 2-4 simultaneous boards. Each board is a separate Omaha hand with its own pot. Win all boards to earn the COMPLETE bonus — 50% extra from every opponent.
...
### Promotional Text (can be changed without new review)
...
1. Go to https://appstoreconnect.apple.com/apps/6760429619
2. Click "App Store" tab → "1.0 Prepare for Submission"
3. Fill in all fields above
4. Upload screenshots (from screenshots/6.7/ and screenshots/6.1/)
5. Set Age Rating questionnaire (Simulated Gambling = Yes)
6. Submit for Review
