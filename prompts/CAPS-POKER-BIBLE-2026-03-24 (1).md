...
| 6 | Duplicate cards bug | Session 4 | ⚠️ PARTIAL S46 | 3/10 | Guard added but still occurs. S49 will add V2 fix + runtime assertion. |
...
| 9 | One board at a time | Session 1 | ⚠️ BASIC | 4/10 | Shows results but not TV broadcast style. Needs full redesign with turn/river drama. |
...
| 30b | **Boards resize on bot finish** | Session 4 user report | 🔴 BUG | 3/10 | Boards shrink when bot places cards fast, destroying readability. S49 will lock board height. |
...
| 5 | Duplicate cards on boards | User | Session 4 | ⚠️ PARTIAL S46 | Guard added but still occurs. V2 fix needed in S49. |
...
| 9 | Boards shrink on bot finish | User | Session 4 | 🔴 OPEN | Board layout recalculates when bot places cards. S49 will lock. |
| 10 | Reveal not TV quality | User | Session 4 | 🔴 OPEN | Basic overlay, not broadcast-style turn/river drama. S49 redesign. |
